...
public class Categoria {
	...
	public Categoria(int id, String nombre) {
		super();
		if (logger.isDebugEnabled()) {
			logger.debug("Categoria(int id={}, String nombre={}) - start", id, nombre); //$NON-NLS-1$
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("Categoria(int id={}, String nombre={}) - end", id, nombre); //$NON-NLS-1$
		}
	}
	...
	public String toString() {
		...
		String returnString = "Categoria [id=" + id + ", nombre=" + nombre + "]";
		if (logger.isDebugEnabled()) {
	...
	public boolean equals(Object obj) {
		...
		boolean returnboolean = this.id == ((Categoria) obj).id;
		if (logger.isDebugEnabled()) {
